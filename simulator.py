...
class Dispatcher:
    ...
    def assign_car_to_user(self, optimal_solution):
        ...
        for optimal_match in optimal_solution:
            ...
            user.assignment_cost = round(assignment_cost, ndigits=3)
...
if __name__ == "__main__":
    ...
    for simulation_id in tqdm(range(0, 10)): 
        ...
        simulation = RideSharingSimulation(env=env, id=float(simulation_id), num_cars=20, num_users=0, inflow_rate=22, map_size=(10, 10), simulation_time=4000)
        simulation.run()
